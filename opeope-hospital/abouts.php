...
<body>
    <div class="content">
        <div class="nav-bar shadow-sm">
            ...
            <div class="nav-bar content2">
                ...
                <div class="nav-bar-navigator">
                    ...
                    <lix class="nav-bar-navigator navigate"><a class="active" href="abouts.php">Abouts</a></lix>
        ...
        <div style="overflow:auto; padding: 2.5% 2.5% 2.5% 2.5%; ">
            ...
            <div class="main">
                <div class="article">
                    <hr style="margin-bottom: 0.5rem"><h2 style="font-size: 1.5rem;">ABOUT US</h2><hr>
                </div>
                <div class="card rounded-0 shadow-sm" style="width: 32%; float: left; padding: 0px;">
                    
                    <div style="max-height: 100%; padding: 30px; overflow-y: hidden;">
                    <img src="assests/images/favicon.png" alt="logo" height="100%" width="100%">
                    </div>
                </div>
                <div class="card rounded-0 shadow-sm" style="width: 65%; float: right; padding: 0px;">
                    <div style="padding: 10px 20px 10px 20px; border-bottom: 1px solid rgba(0, 0, 0, 0.1); background-color: #42b7b9; color: white;"><h4>OPE OPE HOSPITAL</h4></div>
                        ...
                        <div style="margin-top: 0px; margin-bottom: 20px; margin-right: 20px; padding: 20px;">
                            ...
                            <div style="width: 100%; float: left; margin-bottom: 10px;">
                                <div style="width: 100%; margin: 10px; padding: 20px; border: 1px solid #CCCCCC; border-radius: 5px">
                                    <div>
                                        <p>0-2-201-1000, 02-200-3000</p>
                                        <p>270 ถนนพระรามที่หก แขวงทุ่งพญาไท เขตราชเทวี กทม. 10400</p>
                                    </div>
                                    <div>
                                    </div>
                                </div>
