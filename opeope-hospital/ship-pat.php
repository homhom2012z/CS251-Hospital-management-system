...
<?php
    ...
    $disQ = "SELECT * FROM Dispense WHERE PatientID='$sql1'";
    $Dispense = mysqli_query($conn, $disQ);

    $disQ1 = "SELECT * FROM Dispense WHERE PatientID='$sql1'";
                    ...
                    <div style="min-height: 300px; overflow-y: hidden;">
                        <div style="margin-top: 0px; margin-bottom: 20px; margin-right: 20px; padding: 20px;">
                                ...
                                <div style="text-align: center;">
                                    ...
                                    <?php
                                        while($row = mysqli_fetch_array($Dispense2)){?>
                                            <?php echo $row['Tracking']." รายละเอียด: ".$row['Description'];?><br><hr><?php
                                        }
                                    ?>
                                </div>
                            </div>
                            <div style="width: 50%; float: right; margin-bottom: 10px;">
                                ...
                                <form style="font-size: 16px;" action="ship-pat_db.php" method="post">
                                    ...
                                    <div>
                                                <div style="margin-bottom: 10px;">Accpet Pakage</div>
                                    ...
                                    <div style="width: 100%; float: right; margin: 20px; text-align:">
                                                ...
                                                <div style="width:30%; float: left; margin-left: 30px;">
                                                    <button style="background: #7bd1e0;" type="submit" name="shipAccecpt" class="input-regis">Submit</button>
                                                </div>
